      ...
      <div className="flex items-center gap-4 ">
        {token && userData ? (
          ...
          <button
            ...
            className="bg-[#08377b] text-white px-8 py-3 rounded-full font-light hidden md:block"
          >
            Sign Up / Login
          </button>
        )}
        ...
        >
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            ...
            <NavLink
              onClick={() => setShowMenu(false)}
              to="/VirtualAssistantAI"
            >
              <p className="px-4 py-2 rounded-full inline-block">
                VIRTUAL ASSISTANT
              </p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/ai-diagnosis">
              <p className="px-4 py-2 rounded-full inline-block">
                AI DIAGNOSIS
              </p>
            </NavLink>
          ...
          {token && userData ? (
            <div className="flex flex-col items-center gap-2 mt-4 text-base text-gray-700 font-medium">
              <p
                onClick={() => {
                  navigate("/my-profile");
                  setShowMenu(false);
            ...
            <div className="flex justify-center mt-4 w-full">
              <button
                ...
                className="bg-[#08377b] text-white px-6 py-2 rounded-full"
              >
                Sign Up / Login
              </button>
            </div>
